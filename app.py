...
# Page Config
st.set_page_config(page_title="LinkedIn AI Tool", page_icon="👔", layout="wide")

# Sidebar - API Configuration
st.sidebar.title("⚙️ Configuration")
api_provider = st.sidebar.selectbox("Select AI Provider", ["Google Gemini", "OpenAI"])
...
if not api_key:
    st.warning("⚠️ Please enter your API Key in the sidebar to use the tools.")
else:
    st.success("API Key provided! Select a tool from the options below.")
